...
{
    aposRun := true
    abc := "abcdefghijklmnopqrstuvwyz1234567890,."
    Loop, Parse, abc
    {
...
map.insert("^h=","s12")
map.insert("^h\","s12")
map.insert("^h/","addresszeile")
map.insert("^h.","SAPGuiToolTips")
map.insert("^h,","alvToolbarClick")
map.insert("^hq","CursorUpperLeftCorner")
map.insert("^hw","CursorLowerLeftCorner")
map.insert("^hf","CursorLowerRightCorner")
map.insert("^hp","CursorUpperRightCorner")
map.insert("^hz","AppUpperLeftCorner")
map.insert("^hx","AppLowerLeftCorner")
map.insert("^hc","AppLowerRightCorner")
map.insert("^hv","AppUpperRightCorner")
map.insert("^hy","shiftInsert")
map.insert("^hk","convert")
map.insert("^hl","generate_lid")
map.insert("^hm","clickMessage")
prefixKey("^h",map)
return
...
#t::
Run  `C:\Program Files (x86)\Google\Chrome\Application\chrome.exe "www.google.com" --new-window` ,, max
Sleep,  100
WinMaximize, Neuer Tab - Google Chrome
return
